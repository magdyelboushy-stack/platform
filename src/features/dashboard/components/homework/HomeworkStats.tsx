...
export function HomeworkStats({ total, graded, pending, avgScore }: HomeworkStatsProps) {
    const stats = [
        { label: 'إجمالي الواجبات', value: total, icon: FileText, color: 'var(--color-brand)' },
        { label: 'تم التصحيح', value: graded, icon: CheckCircle, color: '#10b981' },
        { label: 'قيد التصحيح', value: pending, icon: Clock, color: '#f59e0b' },
        { label: 'متوسط الدرجات', value: `${avgScore}/20`, icon: Target, color: '#8b5cf6' },
    ];
