...
export function SupportStats({ totalTickets, openTickets, resolvedTickets }: SupportStatsProps) {
    const stats = [
        { label: 'إجمالي التذاكر', value: totalTickets, icon: Ticket, color: 'var(--color-brand)' },
        { label: 'تذاكر مفتوحة', value: openTickets, icon: Clock, color: '#f59e0b' },
        { label: 'تذاكر تم حلها', value: resolvedTickets, icon: CheckCircle, color: '#10b981' },
    ];
